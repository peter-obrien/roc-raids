...
helpMessage.add_field(name="!who [raid-id]", value="Receive a PM from the bot with the details of those that are attending the raid via the !join command.", inline=False)
